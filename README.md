...
TA0006-Credential Access | T1552.004-Unsecured Credentials-Private Keys | Unknown application accessing certificate private key detected | 70 (CAPI2) | CAPI logs activated | 
...
TA0007-Discovery | T1087.002-Domain Account discovery | Honeypot object (container, computer, group, user) accessed | 4662/4624 | SACL config on honeypot | 
...
TA0005-Defense Evasion | T1078.002-Valid accounts-Domain accounts | Login from a user member of a special group detected | 4964 | GPO registry config | 
